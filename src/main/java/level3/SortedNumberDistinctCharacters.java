...
public class SortedNumberDistinctCharacters {
    public static void main(String[] args) {
        ...
        String[] strings = sortStringsByDistinctCharacters(strArr);
    ...
    public static String[] sortStringsByDistinctCharacters(String[] strings) {
